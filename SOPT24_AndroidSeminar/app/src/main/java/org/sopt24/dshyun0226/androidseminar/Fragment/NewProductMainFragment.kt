...
class NewProductMainFragment : Fragment() {
    ...
    fun getMainProductListResponse(){
        val getMainProductListReponse =networkService.getMainProductListResponse("application/json",3)
        getMainProductListReponse.enqueue(object: Callback<GetMainProductListResponse> {
