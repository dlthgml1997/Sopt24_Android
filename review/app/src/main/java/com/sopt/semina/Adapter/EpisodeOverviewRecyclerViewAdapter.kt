...
import com.sopt.semina.Activity.WebtoonActivity
import com.sopt.semina.Data.EpisodeOverviewData
...
class EpisodeOverviewRecyclerViewAdapter(val ctx: Context, val dataList: ArrayList<EpisodeOverviewData>): RecyclerView.Adapter<EpisodeOverviewRecyclerViewAdapter.Holder>(){
    override fun onCreateViewHolder(p0: ViewGroup, p1: Int): EpisodeOverviewRecyclerViewAdapter.Holder {
    val view: View = LayoutInflater.from(ctx).inflate(R.layout.rv_item_episode_overview,p0,false)
        return Holder(view)
    }
